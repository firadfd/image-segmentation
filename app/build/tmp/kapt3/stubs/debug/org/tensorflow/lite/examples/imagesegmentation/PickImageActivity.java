...
public final class PickImageActivity extends androidx.appcompat.app.AppCompatActivity implements org.tensorflow.lite.examples.imagesegmentation.ImageSegmentationHelper.SegmentationListener {
    ...
    private final float getImageSizeRatio(android.content.Context context, android.net.Uri uri) {
        return 0.0F;
    }
    
    private final android.graphics.Bitmap getBitmapFromUri(android.content.Context context, android.net.Uri uri) {
        return null;
    }
